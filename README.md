...
libraryDependencies += "com.apollographql" %%% "apollo-scalajs-core" % "0.6.0" // if you are writing a vanilla Scala.js app
libraryDependencies += "com.apollographql" %%% "apollo-scalajs-react" % "0.6.0" // if you are writing a React Scala.js app
```
